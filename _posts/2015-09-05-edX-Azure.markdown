...
## Connect to edX virtual machine through Remote Desktop Connection
...
4. Now, switch back to the Windows Azure portal, and add an Endpoint for ‘Remote Desktop’ for your virtual machine.
