...
5. run install script
    ...
    note for Dogwood rc3 installation:   `OPENEDX_RELEASE=named-release/dogwood.rc` and adding `apt-get install libmysqlclient-dev` to overcome the error of /tmp/pip-build-3CgUfy/MySQL-pytho
6. restart VM
