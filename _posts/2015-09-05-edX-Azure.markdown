...
5. run install script
    ...
    to pair with [Android app](https://github.com/edx/edx-app-android/releases/tag/release%2F2.5.1), use Ubuntu 12.04 and Eucalyptus `export OPENEDX_RELEASE=open-release/eucalyptus.3`
6. restart VM
